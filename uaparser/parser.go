...
type RegexesDefinitions struct {
	UA     []*uaParser     `yaml:"user_agent_parsers" json:"user_agent_parsers" bson:"user_agent_parsers"`
	OS     []*osParser     `yaml:"os_parsers" json:"os_parsers" bson:"os_parsers"`
	Device []*deviceParser `yaml:"device_parsers" json:"device_parsers" bson:"device_parsers"`
...
type uaParser struct {
	Reg               *regexp.Regexp
	Expr              string  `yaml:"regex" json:"regex" bson:"regex"`
	Flags             string  `yaml:"regex_flag" json:"regex_flag" bson:"regex_flag"`
	FamilyReplacement string  `yaml:"family_replacement" json:"family_replacement" bson:"family_replacement"`
	V1Replacement     string  `yaml:"v1_replacement" json:"v1_replacement" bson:"v1_replacement"`
	V2Replacement     string  `yaml:"v2_replacement" json:"v2_replacement" bson:"v2_replacement"`
	V3Replacement     string  `yaml:"v3_replacement" json:"v3_replacement" bson:"v3_replacement"`
	_                 [4]byte // padding for alignment
	MatchesCount      uint64
}
...
type osParser struct {
	...
	Expr          string  `yaml:"regex" json:"regex" bson:"regex"`
	Flags         string  `yaml:"regex_flag" json:"regex_flag" bson:"regex_flag"`
	OSReplacement string  `yaml:"os_replacement" json:"os_replacement" bson:"os_replacement"`
	V1Replacement string  `yaml:"os_v1_replacement" json:"os_v1_replacement" bson:"os_v1_replacement"`
	V2Replacement string  `yaml:"os_v2_replacement" json:"os_v2_replacement" bson:"os_v2_replacement"`
	V3Replacement string  `yaml:"os_v3_replacement" json:"os_v3_replacement" bson:"os_v3_replacement"`
	V4Replacement string  `yaml:"os_v4_replacement" json:"os_v4_replacement" bson:"os_v4_replacement"`
	_             [4]byte // padding for alignment
	MatchesCount  uint64
}
...
type deviceParser struct {
	...
	Expr              string  `yaml:"regex" json:"regex" bson:"regex"`
	Flags             string  `yaml:"regex_flag" json:"regex_flag" bson:"regex_flag"`
	DeviceReplacement string  `yaml:"device_replacement" json:"device_replacement" bson:"device_replacement"`
	BrandReplacement  string  `yaml:"brand_replacement" json:"brand_replacement" bson:"brand_replacement"`
	ModelReplacement  string  `yaml:"model_replacement" json:"model_replacement" bson:"model_replacement"`
	_                 [4]byte // padding for alignment
	MatchesCount      uint64
}
...
func NewFromDefinitions(definitions RegexesDefinitions) (*Parser, error) {
